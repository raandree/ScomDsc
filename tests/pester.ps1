...
try { Import-Module "$PSScriptRoot/../publish/cScom/cScom.psd1" -ErrorAction Stop } catch { try { Import-Module "$PSScriptRoot/../publish/cScom/cScom.psd1" -ErrorAction Stop } catch {} }
